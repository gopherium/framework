...
[GitHub private vulnerability reporting](https://github.com/gopherium/framework/security/advisories/new)
...
Only the latest release of each module receives security fixes. While
a module is at v0.x there are no backport guarantees.
