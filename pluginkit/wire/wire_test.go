...
func TestGenerateGoAliasesTheSDKAsSdkWhateverItsPackageName(t *testing.T) {
	t.Parallel()

	cfg := testConfig
	cfg.SDKImport = "example.com/myapp/pluginapi"

	got := string(generateGo(cfg, nil))
...
import (
	sdk "example.com/myapp/pluginapi"
)
